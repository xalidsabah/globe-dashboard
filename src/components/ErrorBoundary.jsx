      ...
      return (
        <div className="flex h-full w-full items-center justify-center bg-[#050a14] px-6 text-center">
          <div className="max-w-sm">
            <p className="text-[11px] font-medium tracking-wide text-sky-400/70">Global View</p>
            <h1 className="mt-2 text-lg font-medium text-white/90">Something went wrong</h1>
            <p className="mt-2 text-[13px] leading-relaxed text-white/40">
              The weather globe hit an unexpected error. Reload to try again.
            </p>
            <button
              type="button"
